...
import loginPopupRouter      from './routes/login_popup.mjs';
import vlanPopupsRouter      from './routes/vlan_popups.mjs';
import migrationsRouter      from './routes/migrations.mjs';
...
app.use('/api/login-popup',      loginPopupRouter);
app.use('/api/vlan-popups',      vlanPopupsRouter);
